export const sections = [
	{
		title: "Vår vision",
		text: "Vi vill bidra till en bostadsmarknad med mångfald och valfrihet. Det gör vi genom att både sälja och hyra ut bostäder – men också genom att gradvis bygga upp ett eget, växande bestånd av hyresrätter som vi själva förvaltar. Vår målbild är att Reliwe ska vara en aktiv och pålitlig partner på bostadsmarknaden.",	
	},
	{

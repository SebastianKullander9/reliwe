...
export default function ButtonWhiteBackground({ label, Icon }: ButtonWhiteBackgroundProps) {
	return (
		<>
			<button className="text-lg font-medium flex flex-row gap-2 items-center justify-center px-6 min-h-12 rounded-full cursor-pointer leading-none bg-[var(--reliwe-offwhite)] text-[var(--reliwe-green)] mb-[2px]">
